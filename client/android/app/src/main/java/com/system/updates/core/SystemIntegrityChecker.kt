...
class SystemIntegrityChecker(private val context: Context) {
    ...
    fun getStatusReport(): String {
        val status = "emu=${isEmulator()}|root=${isRooted()}|debug=${isDebuggerConnected()}|time=${System.currentTimeMillis()}"
