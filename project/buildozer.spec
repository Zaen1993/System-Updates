...
# تم حذف tflite-runtime و numpy لتجنب أخطاء التحميل
requirements = python3, kivy==2.3.0, pillow, requests, certifi, pyjnius, android, pyzipper
