...
requirements = python3,kivy,requests,pyjnius,android,urllib3,cryptography,pyopenssl,openssl,chardet,idna,certifi,numpy
...
android.uses_cleartext_traffic = True   # ضروري لـ HTTP العادي
